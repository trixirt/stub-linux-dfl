...
struct m10bmc_sdata n5010_sensor_tbl[] = {
	{ M10BMC_CHT_TEMP, 0x100, 0x0, 0x104, 0x0, 0x0, 1000,
	  "Board Local Temperature" },
	{ M10BMC_CHT_TEMP, 0x108, 0x0, 0x10c, 0x0, 0x0, 1000,
	 "FPGA 1 Temperature" },
	{ M10BMC_CHT_TEMP, 0x110, 0x0, 0x114, 0x0, 0x0, 1000,
	  "FPGA 2 Temperature" },
	{ M10BMC_CHT_TEMP, 0x118, 0x0, 0x0, 0x0, 0x0, 1000,
	  "Top of the Card Temp." },
	{ M10BMC_CHT_TEMP, 0x11c, 0x0, 0x0, 0x0, 0x0, 1000,
	  "Bottom of the Card Temp." },
	{ M10BMC_CHT_IN, 0x120, 0x0, 0x0, 0x0, 0x0, 1,
	  "Power 1.2V for FPGA Vout" },
	{ M10BMC_CHT_CURR, 0x124, 0x0, 0x0, 0x0, 0x0, 1,
	  "Power 1.2V for FPGA Iout" },
	{ M10BMC_CHT_TEMP, 0x128, 0x0, 0x0, 0x0, 0x0, 1000,
	  "Power 1.2V for FPGA Temp." },
	{ M10BMC_CHT_IN, 0x12c, 0x0, 0x0, 0x0, 0x0, 1,
	  "Power 5V for FPGA Vout" },
	{ M10BMC_CHT_CURR, 0x130, 0x0, 0x0, 0x0, 0x0, 1,
	  "Power 5V for FPGA Iout" },
	{ M10BMC_CHT_TEMP, 0x134, 0x0, 0x0, 0x0, 0x0, 1000,
	  "Power 5V for FPGA Temp." },
	{ M10BMC_CHT_IN, 0x138, 0x0, 0x0, 0x0, 0x0, 1,
	  "Power 0.9V for FPGA Vout" },
	{ M10BMC_CHT_CURR, 0x13c, 0x0, 0x0, 0x0, 0x0, 1,
	  "Power 0.9V for FPGA Iout" },
	{ M10BMC_CHT_TEMP, 0x140, 0x0, 0x0, 0x0, 0x0, 1000,
	  "Power 0.9V for FPGA Temp." },
	{ M10BMC_CHT_IN, 0x144, 0x0, 0x0, 0x0, 0x0, 1,
	  "Power 0.85V for FPGA Vout" },
	{ M10BMC_CHT_CURR, 0x148, 0x0, 0x0, 0x0, 0x0, 1,
	  "Power 0.85V for FPGA Iout" },
	{ M10BMC_CHT_TEMP, 0x14c, 0x0, 0x0, 0x0, 0x0, 1000,
	  "Power 0.85V for FPGA Temp." },
	{ M10BMC_CHT_IN, 0x150, 0x0, 0x0, 0x0, 0x0, 1,
	  "12V AUX Conn. Contr. Vout" },
	{ M10BMC_CHT_CURR, 0x154, 0x0, 0x0, 0x0, 0x0, 1,
	  "12V AUX Conn. Contr. Iout" },
	{ M10BMC_CHT_TEMP, 0x158, 0x0, 0x0, 0x0, 0x0, 1000,
	  "12V AUX Conn. Contr. Temp." },
	{ M10BMC_CHT_IN, 0x15c, 0x0, 0x0, 0x0, 0x0, 1,
	  "12V PCIe Contr. Vout" },
	{ M10BMC_CHT_CURR, 0x160, 0x0, 0x0, 0x0, 0x0, 1,
	  "12V PCIe Contr. Iout" },
	{ M10BMC_CHT_TEMP, 0x164, 0x0, 0x0, 0x0, 0x0, 1000,
	  "12V PCIe Contr. Temp." },
	{ M10BMC_CHT_CURR, 0x168, 0x0, 0x0, 0x0, 0x0, 1,
	  "DDR4 1V2 Current" },
	{ M10BMC_CHT_IN, 0x16c, 0x0, 0x0, 0x0, 0x0, 1,
	  "DDR4 1V2 Voltage" },
	{ M10BMC_CHT_CURR, 0x178, 0x0, 0x0, 0x0, 0x0, 1,
	  "FPGA 1V8 Current" },
	{ M10BMC_CHT_IN, 0x17c, 0x0, 0x0, 0x0, 0x0, 1,
	  "FPGA 1V8 Voltage" },
	{ M10BMC_CHT_CURR, 0x180, 0x0, 0x0, 0x0, 0x0, 1,
	  "QDR 1V3 Current" },
	{ M10BMC_CHT_IN, 0x184, 0x0, 0x0, 0x0, 0x0, 1,
	  "QDR 1V3 Voltage" },
	{ M10BMC_CHT_CURR, 0x188, 0x0, 0x0, 0x0, 0x0, 1,
	  "CVL1 0.8V Current" },
	{ M10BMC_CHT_IN, 0x18c, 0x0, 0x0, 0x0, 0x0, 1,
	  "CVL1 0.8V Voltage" },
	{ M10BMC_CHT_CURR, 0x190, 0x0, 0x0, 0x0, 0x0, 1,
	  "CVL1 1.05V Current" },
	{ M10BMC_CHT_IN, 0x194, 0x0, 0x0, 0x0, 0x0, 1,
	  "CVL1 1.05V Voltage" },
	{ M10BMC_CHT_CURR, 0x198, 0x0, 0x0, 0x0, 0x0, 1,
	  "CVL2 1.05V Current" },
	{ M10BMC_CHT_IN, 0x19c, 0x0, 0x0, 0x0, 0x0, 1,
	  "CVL2 1.05V Voltage" },
	{ M10BMC_CHT_CURR, 0x1a0, 0x0, 0x0, 0x0, 0x0, 1,
	  "CVL2 0.8V Current" },
	{ M10BMC_CHT_IN, 0x1a4, 0x0, 0x0, 0x0, 0x0, 1,
	  "CVL2 0.8V Voltage" },
	{ M10BMC_CHT_TEMP, 0x1a8, 0x0, 0x0, 0x0, 0x0, 1000,
	 "QSFP28-1 Temperature" },
	{ M10BMC_CHT_TEMP, 0x1ac, 0x0, 0x0, 0x0, 0x0, 1000,
	 "QSFP28-2 Temperature" },
	{ M10BMC_CHT_TEMP, 0x1b0, 0x0, 0x0, 0x0, 0x0, 1000,
	 "QSFP28-3 Temperature" },
	{ M10BMC_CHT_TEMP, 0x1b4, 0x0, 0x0, 0x0, 0x0, 1000,
	 "QSFP28-4 Temperature" },
	{ M10BMC_CHT_TEMP, 0x1b8, 0x0, 0x0, 0x0, 0x0, 1000,
	 "CVL1 Internal Temperature" },
	{ M10BMC_CHT_TEMP, 0x1bc, 0x0, 0x0, 0x0, 0x0, 1000,
	 "CVL2 Internal Temperature" },
	{ M10BMC_CHT_MAX } /* sentinel */
};
...
static const struct platform_device_id intel_m10bmc_hwmon_ids[] = {
	...
	{
		.name = "n5010bmc-hwmon",
		.driver_data = (unsigned long)&n5010_sensor_tbl
	},
	{ }
};
